...
import com.jezh.hibernate.golovach.jdbc.ConnectionFactoryFactory;
import com.jezh.hibernate.golovach.dao.SUserDao;
import com.jezh.hibernate.golovach.jdbc.ConnectionFactory;
import com.jezh.hibernate.golovach.util.JdbcUtils;

import java.sql.*;
import java.util.ArrayList;
import java.util.List;

import static com.jezh.hibernate.golovach.config.GolovachConfig.DRIVER_CLASS_NAME;
...
//            System.out.println(JdbcUtils.existWithLogin(connection, "jezh"));
    ...
    public static void main(String[] args) {
        ...
        SUserDaoImplProbe test = new SUserDaoImplProbe(ConnectionFactoryFactory.FactoryType.DBCP);
        try {
